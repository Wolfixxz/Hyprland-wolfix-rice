...
hl.animation({ leaf = "windows",       enabled = true,  speed = 4.79, spring = "almostLinear" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 4.1,  spring = "almostLinear",         style = "slide" })
